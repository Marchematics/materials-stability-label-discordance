...
def write_benchmark_card() -> None:
    rows = [
        ("label_source", "Materials Project and MatterGen alex-mp-20 source-native labels", "completed"),
        ("database_version", "MatterGen alex-mp-20 plus MP API-derived records queried during the full run", "completed"),
        ...
        ("source_discordance_burden", "5,060 / 43,139 = 0.1173 on strict MP--alex-mp-20 matches", "completed"),
        ...
        ("exact_denominator_definition", "43,139 strict MP--alex-mp-20 structure matches from 43,984 MatterGen alex-mp-20 rows with MP identifiers", "completed"),
