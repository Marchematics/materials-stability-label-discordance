...
def write_summary() -> None:
    ...
    (OUT / "FULL_MP_ALEX_DENOMINATOR_CLOSEOUT.md").write_text(
        ...
        "This milestone processes all MatterGen alex-mp-20 rows with MP identifiers. It is separate from the frozen 287-row Route-B diagnostic and does not overwrite those artifacts.\n\n"
